            ...
            <div class="form-group">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="send_name" id="send_name" value="{{old('send_name')}}" class="form-control" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td><label>전화번호</label></td>
                        <td><input type="text" name="send_num1" id="send_num1" class="form-control" readonly></td>
                        <td>-</td>
                        <td><input type="text" name="send_num2" id="send_num2" class="form-control" readonly></td>
                        <td>-</td>
                        <td><input type="text" name="send_num3" id="send_num3" class="form-control" readonly></td>
                    </tr>
                    <tr>
                        <td><label>주소</label></td>
                        <td colspan="5"><input type="text" name="send_addr" id="send_addr" class="form-control" readonly></td>
                    </tr>
                    <tr>
                        <td><label>상세주소</label></td>
                        <td colspan="5"><input type="text" name="send_addr2" id="send_addr2" class="form-control" readonly></td>
                    </tr>
                    <tr>
                        <td><label>메모</label></td>
                        <td colspan="5"><input type="text" name="addr_memo" id="addr_memo" class="form-control"></td>
                    </tr>
                </table>
            </div>
        <script>
            ...
            <div class="form-group">
                ...
                <table>
                    <tr>
                        <td><label>이름</label></td>
                        <td><input type="text" name="reci_name" id="reci_name" class="form-control" readonly></td>
                    </tr>
                    <tr>
                        <td><label>전화번호</label></td>
                        <td><input type="text" name="reci_num1" id="reci_num1" class="form-control" readonly></td><td>-</td>
                        <td><input type="text" name="reci_num2" id="reci_num2" class="form-control" readonly></td><td>-</td>
                        <td><input type="text" name="reci_num3" id="reci_num3" class="form-control" readonly></td>
                    </tr>
                </table>
            </div>
            <p>발송 정보</p>
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:40px; text-align:right;" name="addr_amount" id="addr_amount" onchange="amountChange(this.form)" class="form-control{{ $errors->has('addr_amount') ? ' is-invalid' : '' }}">
                    </td>
                    <script language="javascript">
                    ...
                    <td>box</td>
                    <td>
                        <input type="text" style="width:90px; text-align:right;"name="closing_result" id="closing_result" class="form-control" value="0">
                    </td>
                    <td>원</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><select name="addr_send_gubun" id="addr_send_gubun" class="form-control">
                            ...
                            <option value="2">착불</option></select></td>
                </tr>
                <tr>
                    <td><label>상품구분</label></td>
                    <td><select name="addr_gubun" id="addr_gubun" class="form-control">
                            <option value="1" @if($gubun==1) selected @endif>구매</option>
                            <option value="2" @if($gubun==2) selected @endif>이벤트</option></select></td>
                </tr>
                <tr>
                    <td><label>발송예정일</label></td>
                    <td><input type="date" name="addr_date" id="addr_date" class="form-control" value="<?php echo date("Y-m-d");?>"></td>
                </tr>
            </table>
    <br/><p>매출 정보</p>
            <table>
                ...
                <tr>
                    ...
                    <td><select name="addr_courier" id="addr_courier" class="form-control">
                            @foreach($codelist_couriers as $codelist_courier)
                                <option value="{{$codelist_courier->code}}">{{$codelist_courier->content}}</option>
                            @endforeach
                        </select></td>
                </tr>
                <tr>
